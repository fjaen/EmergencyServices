...
namespace EmergencyServicesApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Hospital hosp = new Hospital("Av Sur 48", 22.3, 21.4, "La Fe", null);
            Speciality speci = new Speciality(1, "Cardiología", null);
            Deployment dep = new Deployment(1, 3, 24, hosp, speci);
            ...
            EmergencyCall call = new EmergencyCall(new DateTime(2016, 3, 4), 1, 23.5, 22.5, new TimeSpan(12, 12, 45), pat, null);


            //Relationship Symptom - Speciality
            //Relationship Symptom -> EmergencyCall
            Symptom sy = new Symptom("Taquicardia", 69.5, 1, 3, call, speci);
